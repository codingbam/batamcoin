...
"""Verify that starting batamcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start batamcoin with -h for help text")
        ...
        self.log.info("Start batamcoin with -version for version information")
