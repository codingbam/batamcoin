...
"""Verify that starting visioncoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start visioncoin with -h for help text")
        ...
        self.log.info("Start visioncoin with -version for version information")
