...
"""Verify that starting gladcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start gladcoin with -h for help text")
        ...
        self.log.info("Start gladcoin with -version for version information")
        ...
        self.log.info("Start gladcoind with -fakearg to make sure it does not start")
