...
const char * const BITCOIN_CONF_FILENAME = "visioncoin.conf";
const char * const BITCOIN_PID_FILENAME = "visioncoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Visioncoin";
#else
    // Unix
