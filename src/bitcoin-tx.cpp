...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s visioncoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  visioncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded visioncoin transaction") + "\n" +
              "  visioncoin-tx [options] -create [commands]   " + _("Create hex-encoded visioncoin transaction") + "\n" +
              "\n";
