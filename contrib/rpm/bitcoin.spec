...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 15335
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 15443
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 15335
	%{_sbindir}/semanage port -d -p tcp 15443
