...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 4332
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 4333
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 19332
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 40331
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 19443
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 40333
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 4332
	%{_sbindir}/semanage port -d -p tcp 4333
	%{_sbindir}/semanage port -d -p tcp 19332
	%{_sbindir}/semanage port -d -p tcp 40331
