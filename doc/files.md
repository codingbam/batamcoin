...
* visioncoin.conf: contains configuration settings for visioncoind or visioncoin-qt
* visioncoind.pid: stores the process id of visioncoind while running
...
* debug.log: contains debug information and general logging generated by visioncoind or visioncoin-qt
